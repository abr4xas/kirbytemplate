...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
   ...
   <p>El sitio web abr4xas.org comunica a los usuarios, a trav&eacute;s de este aviso, que puede utilizar cookies cuando el usuario navega por las diferentes pantallas y p&aacute;ginas del sitio.</p>
<p>Durante el uso de nuestro sitio web usted acepta y autoriza expresamente el uso de cookies, de acuerdo con nuestra Pol&iacute;tica de Privacidad.</p>
...
<h2>&iquest;Para qu&eacute; sirven las cookies?</h2>
...
<p>Recordando sus preferencias no tendremos que, por ejemplo, preguntarle por su pa&iacute;s cada vez que visite nuestra Web. Sabremos las caracter&iacute;sticas del ordenador que est&aacute; usando y as&iacute; podremos ofrecerle una mejor experiencia de navegaci&oacute;n. 
Las cookies pueden ayudar a nuestro sitio Web a distinguir el navegador del usuario como visitante anterior y as&iacute; guardar y recordar las preferencias que puedan haberse establecido mientras el usuario estaba navegando por el sitio, personalizar las p&aacute;ginas de inicio, 
identificar qu&eacute; sectores de un sitio han sido visitados o mantener un registro de selecciones en un "carro de compra".</p>
<p>El sitio web abr4xas.org puede utilizar las cookies con el objeto de reconocer a los usuarios que se hayan registrado y poder ofrecerles un mejor servicio y m&aacute;s personalizado. Asimismo pueden ser utilizadas para obtener informaci&oacute;n acerca de la fecha y hora de la &uacute;ltima visita del usuario, 
medir algunos par&aacute;metros de tr&aacute;fico dentro del propio site y estimar el n&uacute;mero de visitas realizadas, de manera que abr4xas.org pueda enfocar y ajustar los servicios y promociones de forma m&aacute;s efectiva.</p>
...
<p>Cookies anal&iacute;ticas: Recogen informaci&oacute;n del uso que se realiza del sitio web.</p>
<p>Cookies sociales: Son necesarias para las redes sociales externas (Facebook, Twitter Linkedin).</p>
<p>Cookies t&eacute;cnicas: Son las estrictamente necesarias para el uso del sitio Web y para la prestaci&oacute;n del servicio contratado.</p>
<h2>Tipos y finalidades de las cookies.</h2>
...
<dl>
  <dt>__utma</dt>
  <dd>Identificaci&oacute;n de visitantes &uacute;nicos: Utilizada para registrar visitantes &uacute;nicos con fines estad&iacute;sticos y anal&iacute;ticos. Duraci&oacute;n: 2 a&ntilde;os y pertenece a Google (Analytic).</dd>
  <dt>__utmb</dt>
  <dd>Determinaci&oacute;n de la sesi&oacute;n del visitante: Google Analytics utiliza dos cookies para establecer una sesi&oacute;n. Si falta alguna de estas dos cookies, otra actividad inicia el comienzo de una nueva sesi&oacute;n. Duraci&oacute;n: 30 minutos y pertenece a Google (Analytic).</dd>   
  <dt>__utmc</dt>
  <dd>Determinaci&oacute;n de la sesi&oacute;n del visitante: Google Analytics utiliza dos cookies para establecer una sesi&oacute;n. Si falta alguna de estas dos cookies, otra actividad inicia el comienzo de una nueva sesi&oacute;n.. Si falta alguna de estas dos cookies, otra actividad inicia el comienzo de una nueva sesi&oacute;n. Es una cookie de sesi&oacute;n y pertenece a Google (Analytic).</dd>        
  <dt>__utmz</dt>
  <dd>Registro de fuentes de tr&aacute;fico y navegaci&oacute;n: Utilizado para registrar c&oacute;mo lleg&oacute; a nuestro sitio Web (por una b&uacute;squeda de Google, un aviso, etc.) y los recorridos que sigue mientras navega nuestro sitio. Utilizamos esta informaci&oacute;n para mejorar la experiencia del usuario en futuras actualizaciones. Duraci&oacute;n: 6 meses y pertenece a Google (Analytic).</dd>      
</dl>

<h2>Salvaguardias de protecci&oacute;n<br>
</h2>
...
<p>Por favor, lea atentamente la secci&oacute;n de ayuda de su navegador para conocer m&aacute;s acerca de como activar el "modo privado". Podr&aacute; seguir visitando nuestra Web aunque su navegador est&eacute; en "modo privado", no obstante, la experiencia de usuario puede no ser &oacute;ptima y algunas utilidades pueden no funcionar.</p>
<p>abr4xas.org le agradece que active la aceptaci&oacute;n de cookies, esto nos ayuda a obtener datos m&aacute;s precisos que nos permiten mejorar el contenido y el dise&ntilde;o de nuestra p&aacute;gina Web para adaptarlo a sus preferencias.</p>
<h2>Cambios en la Pol&iacute;tica de Cookies</h2>
<p>Es posible que actualicemos la Pol&iacute;tica de Cookies de nuestro Sitio Web, por ello le recomendamos revisar esta pol&iacute;tica cada vez que acceda a nuestro Sitio Web con el objetivo de estar adecuadamente informado sobre c&oacute;mo y para qu&eacute; usamos las cookies.</p> 
      ...
      <div class="modal-footer">
          <button type="button" class="btn btn-primary btn-lg btn-block" data-dismiss="modal"><span class="glyphicon glyphicon-ok"></span>
 Ok, lo entiendo.</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->